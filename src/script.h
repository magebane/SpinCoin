...
#ifndef H_spincoin_SCRIPT
#define H_spincoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CspincoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, spincoin always counted CHECKMULTISIGs
