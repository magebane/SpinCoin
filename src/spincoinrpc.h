...
#ifndef _spincoinRPC_H_
#define _spincoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // spincoin is not connected
...
/**
 * spincoin RPC command dispatcher.
 */
class CRPCTable
{
private:
